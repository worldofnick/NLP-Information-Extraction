...
def check_if_person(article_text, uppercase_perp_name):
...
def detect_individuals(article_text, killing_words):
    print "========= PREPS =============="
                ...
                if tuple[1] == 'DET':
                    ...
                    for j in range(i + 1, subject_end_index):
                        ...
                        if t[1] == 'NOUN' or t[1] == 'PROPN' or t[1] == 'ADJ':
                            ...
                            if check_if_person(article_text.title(), compound_perp_name.upper()):
                                perp_individuals.append(compound_perp_name.upper())
                                compound_perp_name = ""
                        else:
                            i = j + 1
                            break
